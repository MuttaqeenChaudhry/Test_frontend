    ...
    <div>
        <div className='w-[250px] h-[290px] shadow-lg pb-4'>
            <div className='w-full h-full'>
                ...
                <a className='h-[10%] block w-fit ml-1 overflow-hidden text-center pl-2 pr-2 pt-1 pb-1 bg-gray-800' href={props.details}><b className='text-white block hover:translate-y-[2px]'>Read More</b></a>
                </div>
